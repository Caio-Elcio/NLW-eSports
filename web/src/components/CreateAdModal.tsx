...
export function CreateAdModal() {
    ...
    return (
        <Dialog.Portal>
            ...
            <Dialog.Content className="fixed bg-[#2A2634] py-5 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
                <Dialog.Title className="text-3xl font-black">Publique um anúncio</Dialog.Title>
                <form className="mt-3 flex flex-col gap-3" onSubmit={handleCreateAd} >
                    <div className="flex flex-col gap-2">
                        ...
                        >
                            ...
                            {games.map(game => {
                                return <option key={game.id} value={game.id}>{game.titles}</option>
                            })}
                        </select>
                    </div>
